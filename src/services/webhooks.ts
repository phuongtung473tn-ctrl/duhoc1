...
export const WEBHOOK_FIELD_OPTIONS = [
  ...
  ["notify_email_configured", "Đã cấu hình email thông báo"],
  ["notification_recipient_count", "Số email thông báo"],
  ["selected_sale_recipient", "Sale được chọn"],
  ...
  ["email_customer_body", "Nội dung email khách"],
  ["email_sales_template", "Mẫu tiêu đề email sale"],
  ["email_sales_body", "Nội dung email sale"],
  ["email_customer_cta_label", "Nhãn nút email khách"],
  ["email_sales_cta_label", "Nhãn nút email sale"],
  ["email_customer_cta_url", "CTA URL khách"],
  ["email_sales_cta_url", "CTA URL sale"],
  ["auto_email_enabled", "Auto email bật"],
  ["auto_email_provider", "Nhà cung cấp auto email"],
  ["auto_email_notify", "Email chỉ định auto email"],
  ["auto_email_sales_list", "Danh sách sale auto email"],
  ["auto_email_customer_subject", "Tiêu đề email khách"],
  ["auto_email_customer_body", "Nội dung email khách"],
  ["auto_email_sales_subject", "Tiêu đề email sale"],
  ["auto_email_sales_body", "Nội dung email sale"],
...
const REQUIRED_LEAD_FIELDS = [
  ...
  "auto_email_provider",
  "auto_email_notify",
  "auto_email_sales_list",
  "auto_email_customer_subject",
  "auto_email_customer_body",
  "auto_email_sales_subject",
  "auto_email_sales_body",
] as const;
