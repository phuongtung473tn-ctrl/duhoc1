...
// Chỉ ước lượng chiều cao; nếu ước lượng cả chiều rộng (1000px) thì các khối
// chưa render sẽ ép trang rộng hơn màn hình điện thoại/iPad gây trôi ngang.
const SECTION_RENDER_HINT = {
  contentVisibility: "auto" as const,
  containIntrinsicHeight: "auto 700px" as const,
};
